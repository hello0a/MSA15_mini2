...
<head>
    ...
    <!-- css 코드 불러오기 -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/user_reserve/reserve.css">
            ...
            <section class="right">
                <div class="reserve">
                    <div class="designer-profile">
                        <img src="${pageContext.request.contextPath}/user_reserve/img/1 (3).jpg" alt="프로필 사진">
